...
class UserBadgesPopup extends React.Component {
            ...
            return (
              ...
              >
                <Avatar
                  ...
                  sx={{ boxShadow: `0 0 4px 6px ${params.row.category_color}` }}
                />
                ;
              </div>
            );
  ...
  handleSubmit(event) {
    ...
    if (this.state.badgeIdToAssign === 0) {
      this.setState({
        badgeIdToAssignErrorMessage: "Veuillez sélectionner un badge",
      });
      return;
    }
          ...
          <DialogContentText>
            ...
            <form>
              <FormControl fullWidth>
                <InputLabel id="badge-select-label">
                  Badge à assigner{" "}
                </InputLabel>
                ...
                <Select
                  ...
                  helperText={
                    this.state.badgeIdToAssignErrorMessage === ""
                      ? ""
                      : this.state.badgeIdToAssignErrorMessage
                  }
                  onChange={this.handleChange}
                >
                  {this.state.leftBadges.length === 0 ? (
                        ...
                        <MenuItem value={badge.id} key={badge.id}>
                          <div className="badge-row">
                            <Avatar
                              ...
                              src={badge.imagePath}
                              sx={{
                                boxShadow: `0 0 4px 8px ${badge.category_color}`,
                              }}
                            />
                            {badge.title}
                          </div>
